...
<div id="layoutSidenav">
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item"><a href="{{route('carousel.dashboard')}}">Carousel</a></li>
                ...
                <div class="card-body">
                    <form action="{{ route('carousel.update', $carousel->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control-file" id="image" name="image" value="{{$carousel->image}}">
